...
//import com.parishta.FirstSelenium.Database;
...
public class RegistrationPage extends BasePage {
	...
	public void activateUser() throws ClassNotFoundException, SQLException {
		new Database().activateGivenUser(userId);
	}*/

public String fillForm(){
	setFirstNameUser("hari");
